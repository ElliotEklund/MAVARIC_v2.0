#ifndef auto_correlation_nrpmd_hpp
#define auto_correlation_nrpmd_hpp
...
class auto_correlation_nrpmd{
   
public:
    
    auto_correlation_nrpmd(int my_id,int nun_procs, int root_proc);
